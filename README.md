...
# SELF ASSESSMENT
Throughout my academic journey at Southern New Hampshire University, I have undergone a significant transformation, transitioning from a background in biology to pursuing a Computer Science degree with a minor in Software Engineering. This shift has been driven by my profound belief in the transformative power of technology and my unwavering dedication to expanding my skills and knowledge in this dynamic field. Despite being a newcomer to the world of Computer Science, my enthusiasm and commitment have propelled me forward, positioning me to make a positive impact through technology.

My academic pursuits have been guided by a diverse perspective, leveraging my previous academic achievements, including an associate degree in biology, to enhance my problem-solving abilities and foster a deeper understanding of the intersection between technology and biology. As evidenced by my coursework and the development of my ePortfolio, I have gained invaluable skills in problem-solving, technical writing, programming, and project management. Additionally, my exploration of various aspects of computer science, such as programming, algorithms, cybersecurity, and data analysis, has equipped me with a well-rounded skill set and a deeper understanding of my potential to drive positive change in society.

My ePortfolio showcases my ability to plan and develop industry-standard code and software programs across three key categories: Software Design and Engineering, Algorithms and Data Structures, and Databases. For instance, the "Inventory App" artifact demonstrates my proficiency in mobile architecture and programming, particularly through the integration of a barcode scanning feature to enhance user experience and functionality. Similarly, the "AllItems" activity of an inventory management app showcases my skills in implementing algorithms and data structures in Android software development, exemplified by the incorporation of a binary search algorithm to optimize search functionality.

Furthermore, the "DBHelper" artifact highlights my ability to manage database operations seamlessly, with a focus on facilitating data mining integration methods for analyzing inventory trends and generating sales forecasts. This Inventory app was developed during my mobile architecture and programming course, and was enchanced during my CS499 course which underscores my commitment to developing efficient enhancements solutions that meet industry standards and address real-world challenges.

Overall, my time in the Computer Science program at Southern New Hampshire University has not only shaped my professional goals and values but has also prepared me to become a valuable asset to prospective employers. With a comprehensive skill set, a dedication to continuous learning, and a passion for leveraging technology for positive change, I am confident in my ability to make meaningful contributions to the field of computer science and beyond.

# Course outcomes
Course Outcome 1: Employing strategic methods, involved conducting comprehensive code review before implementing enhancements, offering developers valuable insights into areas for improvement, and facilitating effective decision-making.  I facilitated the creation of collaborative environments within the computer science domain, enabling diverse audiences to contribute to organizational decision-making. Through enhancements to the Inventory App, including optimized database queries, integrated barcode scanning technology, and improved search functionality, users from various departments can efficiently access and update inventory information, fostering collaborative decision-making processes.

Course Outcome 2: Through meticulous planning and execution, I ensured professional-quality oral, written, and visual communications regarding the enhancements made to the Inventory App. Detailed documentation and clear explanations conveyed the rationale behind these improvements, enabling stakeholders to grasp their significance in inventory management processes. Furthermore, oral presentations effectively communicated the benefits of integrating barcode scanning technology, optimizing database queries, and improving search functionality, promoting a shared understanding among team members.

Course Outcome 3: By employing a thoughtful approach grounded in algorithmic principles and computer science practices, I addressed specific challenges in inventory management through enhancements to the Inventory App. Optimization of database queries, integration of barcode scanning technology, and enhancement of search algorithms exemplify a strategic approach to design choices, carefully managing trade-offs involved. For instance, integrating barcode scanning technology necessitated a careful balance between data accuracy and efficiency, leading to the implementation of error-checking mechanisms to ensure data integrity.

Course Outcome 4: Demonstrating proficiency in both established techniques and innovative solutions, I implemented enhancements to the Inventory App that deliver value and achieve industry-specific goals. Leveraging techniques such as optimized database queries alongside innovative approaches like barcode scanning technology integration, the app effectively addresses challenges in inventory management. For example, the innovative integration of barcode scanning technology streamlines inventory management processes, enhancing efficiency and accuracy.

Course Outcome 5: While prioritizing functionality and usability, I indirectly contributed to developing a security mindset through enhancements to the Inventory App. By optimizing database operations, integrating barcode scanning technology, and improving search algorithms, the app enhances overall integrity and security. For instance, optimizing database queries reduces the risk of data corruption and unauthorized access, while the integration of barcode scanning technology enhances data accuracy, mitigating potential security risks. These enhancements collectively foster a security mindset that anticipates vulnerabilities and prioritizes the privacy and security of data and resources.
...
Journal 6: Academic Reflection: Examining two emerging technologies in the field of Computer Science, alongside Artifact updates
